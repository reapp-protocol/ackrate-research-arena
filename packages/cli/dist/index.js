#!/usr/bin/env node
/**
 * ackrate — CLI for the frozen MandateRegistry protocol. The contract is the
 * source of truth; this tool is a thin client over the published @ackrate packages.
 */
...
program
    .name("ackrate")
    .description("ackrate agent payments on Stellar, enforced on-chain")
    .version(CLI_VERSION);
program
    .command("init")
